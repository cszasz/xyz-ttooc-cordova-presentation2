                    ...
                    if (presentationSession != null) {
                        if (presentationSession.getWebView() != null) {
                            try {
                                ...
                                System.out.println("===========PresentationSession=======setState()==NullPointerException===" + e.getMessage());
                            }
//							getPresentation().getWebView().loadUrl("javascript:NavigatorPresentationJavascriptInterface.onstatechange('" + getId() + "','" + getState() + "')");
                        }
                    } else {
                        System.out.println("Presentation is null =========setState============");
                    }
                }
            });
                        ...
                        if (presentationSession != null) {
                            if (presentationSession.getWebView() != null) {
                                ...
                                try {
                                    ...
                                    System.out.println("===========PresentationSession=======postMessage()===NullPointerException==" + e.getMessage());
                                }
...
//								getPresentation().getWebView().loadUrl("javascript:NavigatorPresentationJavascriptInterface.onmessage('" + getId() + "','" + msg + "')");
                            ...
                            System.out.println("Presentation is null =========postMessage============");
                        }
